...
class SpreadSheet:
    ...
    def append_row(
        ...
        self.sheet.append_row(values=values,)

    def update_lang(self, index: int, lang: str,) -> None:
        "TODO: Mind explaining @vipermu ?"
        self.sheet.update_cell(
            row=index + 2, col=2, value=lang,
        )

    def update_history(self, index: int, new_hist: str,) -> None:
        "TODO: Mind explaining @vipermu ?"
        self.sheet.update_cell(
            row=index + 2, col=3, value=new_hist,
        )
